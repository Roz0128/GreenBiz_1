...
public interface MemberService {
	 ...
	 * 
	 * @param loginParam - 로그인에 사용할 사원번호랑 비밀번호 정보
	 ...
	 * 
	 * @param loginParam - 사번 찾기 위한 이름과 이메일 정보
	 ...
	 * 
	 * @param loginParam - 비밀번호 변경을 위한 사원번호와 이메일 정보
